...
print("ingrese el nombre  completo de padre")
nombrepadre= str (input())
print("ingrese el nombre  completo de la madre ")
nombremadre = str (input())
print("ingrese el nombre del hijo")
hijo= str(input())
nombrepp, apellidopp = nombrepadre.split(" ")
nombremm, apellidomm = nombremadre.split(" ")

print(hijo , apellidopp, apellidomm)
